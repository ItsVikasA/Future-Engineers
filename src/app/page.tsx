...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-400">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-muted-foreground animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-600">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-800">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto pt-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-1000">
      ...
      <section className="relative py-32 px-4 bg-gradient-to-b from-background to-primary/5">
        <div className="container mx-auto">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-6">
      ...
      <section className="relative py-32 px-4">
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="bg-gradient-to-br from-card to-card/50 backdrop-blur-sm border-2 border-primary/20 p-8 md:p-12 relative overflow-hidden">
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <Card className="max-w-5xl mx-auto bg-gradient-to-br from-card to-card/80 backdrop-blur-xl border-2 border-primary/30 p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-purple-500/10 to-pink-500/10"></div>
